...
@seoTitle('Edit Setting')
@section('content')
    <x-backend.page-title heading="Setting" can="edit setting" url=""/>
    <div class="mx-4 mt-5 h-full">
        <x-splade-form action="{{ route('settings.update', $setting->id) }}" method="PUT" :default="$setting">
