...
@seoTitle('Edit Locale')
@section('content')
    <x-backend.page-title heading="Locale" can="edit locale" url=""/>
    <div class="mx-4 mt-5 h-full">
        <x-splade-form action="{{ route('locales.update', $locale) }}" method="PUT" :default="$locale">
            ...
            <div class="flex flex-col sm:flex-row mt-4">
                <x-splade-input class="w-full sm:w-1/2 mr-8 mt-4 sm:mt-0" name="code" label="Code"/>
