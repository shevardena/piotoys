<?php \ProtoneMedia\Splade\Facades\SEO::title('Edit Toy Purchase'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.page-title','data' => ['heading' => 'Toy Purchases','can' => 'edit role','url' => '']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'Toy Purchases','can' => 'edit role','url' => '']); ?>
...
<?php $component = ProtoneMedia\Splade\Components\Form::resolve(['default' => $toy_purchase] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => ''.e(route('toy_purchases.update', $toy_purchase)).'','method' => 'PUT']); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['v-show' => 'data.locale === \''.e($locale->code).'\'','class' => 'w-full sm:w-1/2  mr-8 mt-4 sm:mt-0']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('backend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yoshito/Projects/pio/resources/views/backend/pages/toy_purchase/edit.blade.php ENDPATH**/ ?>