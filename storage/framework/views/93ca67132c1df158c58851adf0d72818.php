...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['appear','show']));
...
foreach (array_filter((['appear','show']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php $component = ProtoneMedia\Splade\Components\Transition::resolve(['appear' => $appear,'show' => $show] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php /**PATH /home/yoshito/Projects/pio/storage/framework/views/0c32457c659c0ab553b2b2e2e14a70a8.blade.php ENDPATH**/ ?>