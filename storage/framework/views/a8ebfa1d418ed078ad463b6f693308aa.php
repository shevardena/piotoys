<?php \ProtoneMedia\Splade\Facades\SEO::title('Administrators'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.page-title','data' => ['heading' => 'Administrators','can' => 'create administrator','url' => ''.e(route('administrators.create')).'','title' => 'Create']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'Administrators','can' => 'create administrator','url' => ''.e(route('administrators.create')).'','title' => 'Create']); ?>
...
<?php $component = ProtoneMedia\Splade\Components\Table::resolve(['for' => $users] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
            <?php $__env->slot('spladeTableCelled49c3fed75a513a79cb8bd1d4715d57', function ($user, $key) use ($__env) { ?> 
                <?php echo e($user->super_admin ? 'Yes' : 'No'); ?>

             <?php }); ?>
            <?php $__env->slot('spladeTableCellebb67a4271abe715344471b0f16321f6', function ($user, $key) use ($__env) { ?> 
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update administrator')): ?>
                    <Link href="<?php echo e(route('administrators.edit', $user->id)); ?>"
                ...
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete administrator')): ?>
                    <Link confirm="You are deleting administrator"
                          confirm-text="Are you sure?"
                          confirm-button="Yes"
                          cancel-button="No"
                          method="DELETE"
                          href="<?php echo e(route('administrators.destroy', $user->id)); ?>"
...
<?php echo $__env->make('backend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yoshito/Projects/pio/resources/views/backend/pages/admin/index.blade.php ENDPATH**/ ?>