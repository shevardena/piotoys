...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['child','afterLeave']));
...
foreach (array_filter((['child','afterLeave']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php $component = ProtoneMedia\Splade\Components\Transition::resolve(['child' => $child,'afterLeave' => $afterLeave] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php /**PATH /home/yoshito/Projects/pio/storage/framework/views/02aeb5933e1aa29c97dfbee1b4cd27b9.blade.php ENDPATH**/ ?>