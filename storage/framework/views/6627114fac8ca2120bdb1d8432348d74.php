<?php \ProtoneMedia\Splade\Facades\SEO::title('Menus'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.page-title','data' => ['heading' => 'Menus','can' => 'create menu','url' => ''.e(route('menus.create')).'','title' => 'Create']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'Menus','can' => 'create menu','url' => ''.e(route('menus.create')).'','title' => 'Create']); ?>
...
<?php $component = ProtoneMedia\Splade\Components\Table::resolve(['for' => $menus] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('backend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yoshito/Projects/pio/resources/views/backend/pages/menu/index.blade.php ENDPATH**/ ?>