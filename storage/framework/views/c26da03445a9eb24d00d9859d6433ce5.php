<?php \ProtoneMedia\Splade\Facades\SEO::title('Import Product Images'); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => ''.e(route('products.store_from_images')).'']); ?>
...
<?php $component = ProtoneMedia\Splade\Components\Form\File::resolve(['name' => 'images[]','multiple' => true,'server' => true,'filepond' => true,'preview' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = ProtoneMedia\Splade\Components\Form\Submit::resolve(['label' => 'Import','spinner' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('backend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yoshito/Projects/pio/resources/views/backend/pages/product/import_images.blade.php ENDPATH**/ ?>