    ...
    <div class="bg-white mx-4 p-4 mt-8 flex items-center flex-wrap">
        <ol class="flex items-center whitespace-nowrap min-w-0" aria-label="Breadcrumb">
            <?php $__currentLoopData = $breadcrumbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $breadcrumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($loop->first && $breadcrumbs->count() > 1): ?>
                    <li class="text-sm">
                        <Link class="flex items-center text-gray-500 hover:text-blue-600" href="<?php echo e($breadcrumb->url); ?>">
                ...
                <?php endif; ?>
                <?php if($loop->index === 2 && $breadcrumbs->count() > 2): ?>
                    <li class="text-sm">
                        <Link class="flex items-center text-gray-500 hover:text-blue-600" href="<?php echo e($breadcrumb->url); ?>">
                        <?php echo e($breadcrumb->title); ?>
                ...
                <?php endif; ?>
                <?php if($loop->last && ($breadcrumbs->count() > 2 || $breadcrumbs->count() == 2)): ?>
                    <li class="text-sm">
                        <?php echo e($breadcrumb->title); ?>
...
<?php /**PATH /home/yoshito/Projects/pio/resources/views/backend/partials/_breadcrumbs.blade.php ENDPATH**/ ?>