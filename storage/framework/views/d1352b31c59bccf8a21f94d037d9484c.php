...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['animation','appear','show']));
...
foreach (array_filter((['animation','appear','show']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php $component = ProtoneMedia\Splade\Components\Transition::resolve(['animation' => $animation,'appear' => $appear,'show' => $show] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php /**PATH /home/yoshito/Projects/pio/storage/framework/views/a4831aa28b752e0375fde8b0d092a685.blade.php ENDPATH**/ ?>