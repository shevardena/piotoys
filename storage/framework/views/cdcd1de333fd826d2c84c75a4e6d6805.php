<?php \ProtoneMedia\Splade\Facades\SEO::title('Roles'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.page-title','data' => ['heading' => 'Roles','can' => 'create role','url' => ''.e(route('roles.create')).'','title' => 'Create']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'Roles','can' => 'create role','url' => ''.e(route('roles.create')).'','title' => 'Create']); ?>
...
<?php $component = ProtoneMedia\Splade\Components\Table::resolve(['for' => $roles] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
            <?php $__env->slot('spladeTableCellebb67a4271abe715344471b0f16321f6', function ($role, $key) use ($__env) { ?> 
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update role')): ?>
                    <Link href="<?php echo e(route('roles.edit', $role->id)); ?>"
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete role')): ?>
                    <Link confirm="You are deleting role"
                          confirm-text="Are you sure?"
                          confirm-button="Yes"
                          cancel-button="No"
                          method="DELETE"
                          href="<?php echo e(route('roles.destroy', $role->id)); ?>"
...
<?php echo $__env->make('backend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yoshito/Projects/pio/resources/views/backend/pages/role/index.blade.php ENDPATH**/ ?>