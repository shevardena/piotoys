<?php \ProtoneMedia\Splade\Facades\SEO::title('Categories'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.page-title','data' => ['heading' => 'Categories','can' => 'create category','url' => ''.e(route('categories.create')).'','title' => 'Create']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'Categories','can' => 'create category','url' => ''.e(route('categories.create')).'','title' => 'Create']); ?>
...
<?php $component = ProtoneMedia\Splade\Components\Table::resolve(['for' => $categories] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
            <?php $__env->slot('spladeTableCell67daf92c833c41c95db874e18fcb2786', function ($category, $key) use ($__env) { ?> 
                <?php echo $category->description; ?>

             <?php }); ?>
            <?php $__env->slot('spladeTableCell4264c638e0098acb172519b0436db099', function ($category, $key) use ($__env) { ?> 
                <?php echo e($category->is_active == 1 ? 'true' : 'false'); ?>

             <?php }); ?>
            <?php $__env->slot('spladeTableCellebb67a4271abe715344471b0f16321f6', function ($category, $key) use ($__env) { ?> 
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update category')): ?>
                    <Link href="<?php echo e(route('categories.edit', $category->id)); ?>"
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete category')): ?>
                    <Link confirm="You are deleting toy category"
                          ...
                          cancel-button="No"
                          method="DELETE"
                          href="<?php echo e(route('categories.destroy', $category->id)); ?>"
...
<?php echo $__env->make('backend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yoshito/Projects/pio/resources/views/backend/pages/category/index.blade.php ENDPATH**/ ?>